            ...
            <div className='bg-zinc-900 text-gray-100'>
                <nav className='flex items-center justify-between max-w-screen-lg mx-auto text-gray-100 h-14'>
                    <div className='flex items-center'>
                        ...
                        <Link href="/" className='h-full flex items-center mr-4'>
                            <Image className='h-8 lg:h-12 w-auto '
                                alt='Logo JV.com'
                ...
                <div className='bg-black lg:relative lg:bottom-auto absolute bottom-[220px]  '>
                    <nav className={`
